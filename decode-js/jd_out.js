...
var D_ = function () {
    ...
    kp.gZmEb(Id, Tp, [{
              ...
              switch (t.prev = t.next) {
                ...
                case 12:
                  ...
                  this["__requestA" + "lgorithm"]().catch(function (t) {
                    ...
                    l(Ax, Ir._debug, ("__requestD" + "eps reques" + "t token fa" + (f = -790, s = -795, p(0, f - -1860, s) + "r: ")).concat(t));
                  });
      ...
      value: function (t) {
        var r,
          y = "8|4|0|2|1|7|6|10|11|3|9|5".split("|"),
          g = 0;
        ...
        for (; ;) {
          switch (y[g++]) {
            ...
            case "10":
              if (kp.aQSrQ(bx, t)) {
                var j = {};
                j.code = yb["UNSIGNABLE" + "_PARAMS"];
                j.message = "params con" + "tains rese" + "rved param" + " name.";
                _ = j;
              }
          ...
          switch (e[i++]) {
            ...
            case "2":
              if (this._isNormal) {
                ...
                f.message = kp.nrOom;
                this["_onRequest" + "Token"](f);
                c = this.__genKey(this._token, this["_fingerpri" + "nt"], a, this._appId, this.algos).toString() || "";
              } else {
                this["_defaultTo" + "ken"] = kp.AqAHu(a_, this["_fingerpri" + "nt"]);
                var s = {
                  code: 1
                };
                s.message = kp.yFtEs;
                this["_onRequest" + "Token"](s);
                c = this["__genDefau" + "ltKey"](this["_defaultTo" + "ken"], this["_fingerpri" + "nt"], a, this._appId);
              }
            ...
            case "4":
              if (!c) {
                if (this._token || this["_defaultTo" + "ken"]) {
                  var l = {};
                  l.code = yb["GENERATE_S" + "IGNATURE_F" + "AILED"];
                  l.message = "generate k" + "ey failed";

                  this._onSign(l);
                } else {
                  var h = {};
                  h.code = yb["TOKEN_EMPT" + "Y"];
                  h.message = kp.tjKSX;
              ...
              var p = "5|0|3|7|1|2|4|6".split("|"), d = 0
              for (; ;) {
                switch (p[d++]) {
                  case "0":
                  ...
                  case "7":
                    var _ = this["__genSignP" + "arams"](b, z, v, r);
